...
def load_configs_model(model_name='darknet', configs=None):
    ...
    if model_name == "darknet":
        ...
        # Got parameters from https://github.com/maudzung/SFA3D/blob/master/sfa/test.py
...
def create_model(configs):
    ...
    if (configs.arch == 'darknet') and (configs.cfgfile is not None):
        ...
        print("student task ID_S3_EX1-4")
                ...
                # Using https://knowledge.udacity.com/questions/877243
...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        if 'darknet' in configs.arch:
            ...
            # Using https://knowledge.udacity.com/questions/807002
    ...
    # Using https://knowledge.udacity.com/questions/820147
